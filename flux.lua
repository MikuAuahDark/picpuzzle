...
--
-- This flux is modified to support custom interpolation by specifying function to :ease(func)
...
local function geteasing(p)
	return type(p) == "function" and p or flux.easing[p]
end
...
function flux:update(deltatime)
  for i = #self, 1, -1 do
    ...
    if t._delay > 0 then
      ...
      local p = t.progress
      local x = p >= 1 and 1 or geteasing(t._ease)(p)
