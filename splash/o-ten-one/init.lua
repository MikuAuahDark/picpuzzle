...
function splashlib.new(init)
  ...
  if init.fill == "rain" then
    ...
    rain.spacing_x = 110
    rain.spacing_y = 80
    rain.image = love.graphics.newImage("splash/baby.png")
  ...
  self.alpha = 1
  self.heart = {
    sprite = love.graphics.newImage("splash/heart.png"),
    scale = 0,
    rot   = 0
  }
  ...
  self.logo = {
    sprite = love.graphics.newImage("splash/logo.png"),
    mask   = love.graphics.newImage("splash/logo-mask.png"),
    pen    = 0
  }
